...
export const TodoList = (props: { tab: 'all' | 'pending' | 'completed' }) => {
  const [parent] = useAutoAnimate()
  let array: ('completed' | 'pending')[] = []
      ...
      {todos.map((todo) => (
        <li key={todo.id}>
          <div
            ...
            } flex items-center justify-between gap-4 rounded-12 border border-gray-200 px-4 py-3 shadow-sm`}
          >
            ...
            <button
              ...
              className="inline-flex h-8 w-8 items-center justify-center p-1"
            >
